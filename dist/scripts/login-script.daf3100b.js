...
angular.module("OSSLogin", [ "ngCookies", "ngResource", "ngRoute", "ngSanitize", "ngTouch", "ui.bootstrap", "angularSpinner", "OSSCommon" ]).controller("MainCtrl", [ "$scope", "OSSException", "OSSRegion", "OSSConfig", "$timeout", function($scope, OSSException, OSSRegion, OSSConfig, $timeout) {
