...
angular.module("OSSCommon", [ "ui.select" ]).config([ "uiSelectConfig", function(uiSelectConfig) {
...
angular.module("ossClientUiApp", [ "ngCookies", "ngResource", "ngRoute", "ngSanitize", "ngTouch", "ui.bootstrap", "angularSpinner", "OSSCommon", "angularSpinner", "ng-context-menu", "ui.select" ]).config([ "$routeProvider", "$httpProvider", "uiSelectConfig", function($routeProvider, $httpProvider, uiSelectConfig) {
    uiSelectConfig.theme = "bootstrap";
