 ...
 */
    .factory('OSSException', ['OSSConfig','gettext','gettextCatalog', function (OSSConfig,gettext,gettextCatalog) {
        var erroList = {
            ...
            'InvalidParameter.Role.InvalidChars':gettextCatalog.getString(gettext('角色名称含有不支持的字符')),
            'InvalidParameter.AssumeRolePolicyDocument.Length':gettextCatalog.getString(gettext('策略规则长度超过限制')),
            'EntityAlreadyExists.Role':gettextCatalog.getString(gettext('角色已存在')),
            'LimitExceeded.Role':gettextCatalog.getString(gettext('角色数已达最大限制')),
            'EntityNotExist.Role':gettextCatalog.getString(gettext('角色不存在')),
            'DeleteConflict.Role.Policy':gettextCatalog.getString(gettext('角色还存在策略规则')),
            'InvalidParameter.UserName.InvalidChars':gettextCatalog.getString(gettext('用户名称含有不支持的字符')),
            'InvalidParameter.DisplayName.InvalidChars':gettextCatalog.getString(gettext('用户显示名称含有不支持的字符')),
            'EntityAlreadyExists.User':gettextCatalog.getString(gettext('用户已存在')),
            'LimitExceeded.User':gettextCatalog.getString(gettext('用户数量已达最大限制')),
            'EntityNotExist.User':gettextCatalog.getString(gettext('用户不存在')),
            'InvalidParameter.NewMobilePhone.Format':gettextCatalog.getString(gettext('手机号码格式错误')),
            'InvalidParameter.NewEmail.Format':gettextCatalog.getString(gettext('邮箱格式错误')),
            'DeleteConflict.User.AccessKey':gettextCatalog.getString(gettext('当前用户还有创建的AK')),
            'LimitExceeded.User.AccessKey':gettextCatalog.getString(gettext('用户AK已达最大限制')),
            'EntityNotExist.User.AccessKey':gettextCatalog.getString(gettext('用户AK不存在')),
            'EntityAlreadyExists.Group':gettextCatalog.getString(gettext('用户组已存在')),
            'LimitExceeded.Group':gettextCatalog.getString(gettext('用户组已达最大限制')),
            'EntityNotExist.Group':gettextCatalog.getString(gettext('用户组不存在')),
            'EntityAlreadyExists.Policy':gettextCatalog.getString(gettext('授权策略已存在')),
            'LimitExceeded.Policy':gettextCatalog.getString(gettext('授权策略已达最大限制')),
            'EntityNotExist.Policy':gettextCatalog.getString(gettext('授权策略不存在')),
            'DeleteConflict.Policy.User':gettextCatalog.getString(gettext('授权策略下还有用户')),
            'DeleteConflict.Policy.Group':gettextCatalog.getString(gettext('授权策略下还有用户组')),
            'DeleteConflict.Policy.Version':gettextCatalog.getString(gettext('授权策略下还有其他版本')),
            'LimitExceeded.Policy.Version':gettextCatalog.getString(gettext('版本数已达最大限制')),
            'EntityNotExist.Policy.Version':gettextCatalog.getString(gettext('版本号不存在')),
            'DeleteConflict.Policy.Version.Default':gettextCatalog.getString(gettext('默认版本号不能删除')),
            'EntityAlreadyExists.User.Policy':gettextCatalog.getString(gettext('用户已经授权了该策略')),
            'LimitExceeded.User.Policy':gettextCatalog.getString(gettext('用户添加的授权策略已达最大限制')),
            'EntityNotExist.User.Policy':gettextCatalog.getString(gettext('用户未授权该策略')),
            'EntityAlreadyExists.Group.Policy':gettextCatalog.getString(gettext('用户组已经授权了该策略')),
            'LimitExceeded.Group.Policy':gettextCatalog.getString(gettext('用户组添加的授权策略已达最大限制')),
            'EntityNotExist.Group.Policy':gettextCatalog.getString(gettext('用户组未授权该策略')),
            'EntityAlreadyExists.Role.Policy':gettextCatalog.getString(gettext('角色已经授权了该策略')),
            'LimitExceeded.Role.Policy':gettextCatalog.getString(gettext('角色添加的授权策略已达最大限制')),
            'EntityNotExist.Role.Policy':gettextCatalog.getString(gettext('角色未授权该策略')),
            'MalformedPolicyDocument':gettextCatalog.getString(gettext('策略规则不正确'))
        };
        return {
